...
public class GetAffineFramesTests extends FramesAnalyser {
    ...
    private void mockData() {
        ...
        List<SnapshotTransformationPair> data = new ArrayList<>(Arrays.asList(
                new SnapshotTransformationPair(new SnapshotPair().setX(null, 0L).setY(null, 1L), unimportant),
                new SnapshotTransformationPair(new SnapshotPair().setX(null, 1L).setY(null, 2L), unimportant),
                new SnapshotTransformationPair(new SnapshotPair().setX(null, 2L).setY(null, 3L), unimportant),
                new SnapshotTransformationPair(new SnapshotPair().setX(null, 3L).setY(null, 4L), unimportant),
                new SnapshotTransformationPair(new SnapshotPair().setX(null, 4L).setY(null, 5L), shear),
                new SnapshotTransformationPair(new SnapshotPair().setX(null, 5L).setY(null, 6L), shear),
                new SnapshotTransformationPair(new SnapshotPair().setX(null, 6L).setY(null, 7L), shear),
                new SnapshotTransformationPair(new SnapshotPair().setX(null, 7L).setY(null, 8L), shear),
                new SnapshotTransformationPair(new SnapshotPair().setX(null, 8L).setY(null, 9L), shear),
                new SnapshotTransformationPair(new SnapshotPair().setX(null, 9L).setY(null, 10L), unimportant),
                new SnapshotTransformationPair(new SnapshotPair().setX(null, 10L).setY(null, 11L), unimportant),
                new SnapshotTransformationPair(new SnapshotPair().setX(null, 11L).setY(null, 12L), unimportant),
                new SnapshotTransformationPair(new SnapshotPair().setX(null, 12L).setY(null, 13L), skew),
                new SnapshotTransformationPair(new SnapshotPair().setX(null, 13L).setY(null, 14L), skew),
                new SnapshotTransformationPair(new SnapshotPair().setX(null, 14L).setY(null, 15L), skew),
                new SnapshotTransformationPair(new SnapshotPair().setX(null, 15L).setY(null, 16L), skew),
                new SnapshotTransformationPair(new SnapshotPair().setX(null, 16L).setY(null, 17L), skew),
                new SnapshotTransformationPair(new SnapshotPair().setX(null, 17L).setY(null, 18L), skewAndShear),
                new SnapshotTransformationPair(new SnapshotPair().setX(null, 18L).setY(null, 19L), unimportant),
                new SnapshotTransformationPair(new SnapshotPair().setX(null, 19L).setY(null, 20L), unimportant)
        ));
